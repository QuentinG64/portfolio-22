  ...
  return loading ? (
    ...
    <div name="About" className="h-screen w-screen">
      ...
      <div className="text-main-3 font-xlight text-2xl flex flex-row mt-20">
        ...
        <div className="flex-col w-full ml-40 mr-40 text-justify">
          <Reveal>
            <div>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis
              mollis luctus rhoncus. Curabitur sem ante, sollicitudin quis enim
              nec, dictum consequat diam. <br /> <br /> Mauris iaculis sapien
              vitae elit fermentum, vel aliquam nisi luctus. Nam finibus maximus
              maximus. Nullam maximus massa nibh, elementum egestas nibh
              vulputate sit amet.
              <br /> <br />
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis
              mollis luctus rhoncus. Curabitur sem ante, sollicitudin quis enim
              nec, dictum consequat diam.
              <div className="mt-24 text-bg-2 w-[100%] flex items-center flex-col text-m">
